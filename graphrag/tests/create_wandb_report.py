...
acc_llm_service_bar_plot = wr.PanelGrid(
    runsets=[
        wr.Runset(
            project="GraphRAG", name="LLM Service Grouping", groupby=["llm_service"]
...
acc_question_type_bar_plot = wr.PanelGrid(
    runsets=[
        wr.Runset(
            project="GraphRAG", name="Question Type Grouping", groupby=["question_type"]
        ).set_filters_with_python_expr(python_filter)
    ],
    panels=[
        wr.BarPlot(
...
acc_parallel_cords = wr.PanelGrid(
    runsets=[wr.Runset(project="GraphRAG").set_filters_with_python_expr(python_filter)],
    panels=[
